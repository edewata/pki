...
Export the DS signing certificate for the directory server into `ds_signing.crt`.
See [Exporting DS Certificates](https://github.com/dogtagpki/pki/wiki/Exporting-DS-Certificates).
...
After installation the DS signing certificate and the CA system certificates with their keys will be stored
