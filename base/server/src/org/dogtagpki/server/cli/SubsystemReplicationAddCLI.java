 ...
 */
public class SubsystemReplicationAddCLI extends CommandCLI {

    public static Logger logger = LoggerFactory.getLogger(SubsystemReplicationAddCLI.class);

    public SubsystemReplicationAddCLI(CLI parent) {
        super("add", "Add " + parent.getParent().getName().toUpperCase() + " replication agreement", parent);
    }
