 ...
 */
public class SubsystemDBACLAddCLI extends CommandCLI {

    public static Logger logger = LoggerFactory.getLogger(SubsystemDBACLAddCLI.class);

    public SubsystemDBACLAddCLI(CLI parent) {
        super("add", "Add " + parent.parent.parent.getName().toUpperCase() + " manager ACLs", parent);
    }
    ...
    public void execute(CommandLine cmd) throws Exception {
        ...
        try {
            ...
            logger.info("Adding ACLs for " + userDN);

            File file = new File("/usr/share/pki/server/conf/manager-acl-add.ldif");
            File tmpFile = File.createTempFile("manager-acl-add-", ".ldif");
