...
public class AuthSubsystem implements ISubsystem {
    ...
    public AuthenticationConfig mConfig;
    ...
    public void loadAuthManagerPlugins() throws EBaseException {
        ...
        while (mImpls.hasMoreElements()) {
            ...
            logger.info("AuthSubsystem: Loading auth manager plugin " + id);

            String pluginPath = c.getString(id + "." + PROP_CLASS);
            plugin = new AuthMgrPlugin(id, pluginPath);
    ...
    public void loadAuthManagers() throws EBaseException {
        ...
        logger.info("AuthSubsystem: Loading auth manager " + PASSWDUSERDB_AUTHMGR_ID);
        ...
        logger.info("AuthSubsystem: Loading auth manager " + CERTUSERDB_AUTHMGR_ID);
        ...
        logger.info("AuthSubsystem: Loading auth manager " + CHALLENGE_AUTHMGR_ID);
        ...
        // #56659
        // logger.info("AuthSubsystem: Loading auth manager " + NULL_AUTHMGR_ID);
        //
        ...
        logger.info("AuthSubsystem: Loading auth manager " + SSLCLIENTCERT_AUTHMGR_ID);
        ...
        while (instances.hasMoreElements()) {
            ...
            logger.info("AuthSubsystem: Loading auth manager " + insName);
