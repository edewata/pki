...
class SDHostCLI(pki.cli.CLI):
    ...
    def __init__(self):
        ...
        self.add_module(SDHostFindCLI())
        self.add_module(SDHostAddCLI())
        self.add_module(SDHostRemoveCLI())


class SDHostFindCLI(pki.cli.CLI):

    def __init__(self):
        super().__init__('find', 'Find security domain hosts')

    def print_help(self):
        print('Usage: pki-server sd-host-find [OPTIONS]')
        print()
        print('  -i, --instance <instance ID>       Instance ID (default: pki-tomcat).')
        print('  -v, --verbose                      Run in verbose mode.')
        print('      --debug                        Run in debug mode.')
    ...
    def execute(self, argv):
        ...
        subsystem.find_security_domain_hosts()
...
class SDHostRemoveCLI(pki.cli.CLI):

    def __init__(self):
        super().__init__('del', 'Remove security domain host')

    def print_help(self):
        print('Usage: pki-server sd-host-del [OPTIONS] <host ID>')
        print()
        print('  -i, --instance <instance ID>       Instance ID (default: pki-tomcat).')
        print('  -v, --verbose                      Run in verbose mode.')
        print('      --debug                        Run in debug mode.')
    ...
    def execute(self, argv):
        ...
        subsystem.remove_security_domain_host(host_id)
