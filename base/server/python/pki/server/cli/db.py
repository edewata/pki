...
class SubsystemDBCLI(pki.cli.CLI):
    ...
    def __init__(self, parent):
        ...
        self.add_module(SubsystemDBACLCLI(self))
...
class SubsystemDBACLCLI(pki.cli.CLI):

    def __init__(self, parent):
        super(SubsystemDBACLCLI, self).__init__(
            'acl', '%s ACL management commands' % parent.parent.name.upper())

        self.parent = parent
        self.add_module(SubsystemDBACLAddCLI(self))
        self.add_module(SubsystemDBACLDeleteCLI(self))


class SubsystemDBACLAddCLI(pki.cli.CLI):
