...
class CACLI(pki.cli.CLI):
    ...
    def __init__(self):
        ...
        self.add_module(CADeployCLI())
        self.add_module(CAUndeployCLI())
...
class CADeployCLI(pki.cli.CLI):

    def __init__(self):
        super(CADeployCLI, self).__init__(
            'deploy', 'Deploy CA subsystem')

    def print_help(self):
        print('Usage: pki-server ca-deploy [OPTIONS] [name]')
        print()
        print('  -i, --instance <instance ID>       Instance ID (default: pki-tomcat).')
        print('  -v, --verbose                      Run in verbose mode.')
        print('      --debug                        Run in debug mode.')
    ...
    def execute(self, argv):
        ...
        descriptor = os.path.join(pki.server.PKIServer.SHARE_DIR,
                                  'ca/conf/Catalina/localhost/ca.xml')
...
class CAUndeployCLI(pki.cli.CLI):

    def __init__(self):
        super(CAUndeployCLI, self).__init__(
            'undeploy', 'Undeploy CA subsystem')

    def print_help(self):
        print('Usage: pki-server ca-undeploy [OPTIONS] [name]')
        print()
        print('  -i, --instance <instance ID>       Instance ID (default: pki-tomcat).')
        print('  -v, --verbose                      Run in verbose mode.')
        print('      --debug                        Run in debug mode.')
