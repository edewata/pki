...
class NSSDatabase(object):
    ...
    def __create_basic_constraints_ext(self, exts, basic_constraints_ext):
        '''
        Create basic constraints extension for pki nss-cert-request/issue.
        '''
    ...
    def __create_key_usage_ext(self, exts, key_usage_ext):
        '''
        Create key usage extension for pki nss-cert-request/issue.
        '''
    ...
    def __create_extended_key_usage_ext(self, exts, extended_key_usage_ext):
        '''
        Create extended key usage extension for pki nss-cert-request/issue.
        '''
    ...
    def __create_ski_ext(self, exts, ski_ext):
        '''
        Create SKI extension for pki nss-cert-request/issue.
        '''
    ...
    def __create_aki_ext(self, exts, aki_ext):
        '''
        Create AKI extension for pki nss-cert-request/issue.
        '''
