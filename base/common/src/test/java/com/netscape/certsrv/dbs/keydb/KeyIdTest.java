...
public class KeyIdTest {
    ...
    // data #2: 1 byte
    String DATA2_HEX = "0x06";
    String DATA2_JSON = "\"0x06\"";
    byte[] DATA2_BYTES = new byte[] {
            (byte) 0x06,
    };

    // data #3: 16 bytes
    String DATA3_HEX = "0x28405e456904f79ccb9118196023153b";
    String DATA3_JSON = "\"0x28405e456904f79ccb9118196023153b\"";
    byte[] DATA3_BYTES = new byte[] {
            (byte) 0x28, (byte) 0x40, (byte) 0x5e, (byte) 0x45,
            (byte) 0x69, (byte) 0x04, (byte) 0xf7, (byte) 0x9c,
            (byte) 0xcb, (byte) 0x91, (byte) 0x18, (byte) 0x19,
            (byte) 0x60, (byte) 0x23, (byte) 0x15, (byte) 0x3b
    };

    // data #4: 20 bytes with leading zero
    String DATA4_HEX = "0x004128630eae9cdaf342b21e55571019c4f06368";
    String DATA4_JSON = "\"0x004128630eae9cdaf342b21e55571019c4f06368\"";
