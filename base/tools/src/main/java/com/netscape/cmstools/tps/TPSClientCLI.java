...
public class TPSClientCLI extends CommandCLI {
    ...
    public native void useOldStyle(long client, boolean value) throws Exception;
    ...
    public native void displayVariables(long client) throws Exception;
