...
public class PasswordGenerateCLI extends CommandCLI {
    ...
    public char getPunctuation(int index) {
     ...
     */
    public char[] generatePassword(Random random, int length) {
     ...
     */
    public char[] generatePassword(Random random, String characters, int length) {
