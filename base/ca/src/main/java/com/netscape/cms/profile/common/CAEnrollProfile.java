...
public class CAEnrollProfile extends EnrollProfile {
        ...
        if (isSSKeygen) {
            ...
            if (options != null) {
                ...
                try {
                    ...
                    logger.info("CAEnrollProfile: Key archival completed");
        ...
        if (isSSKeygen) {
            try {
                ...
                if (infokey != null) {
                    ...
                    // a placeholder temporary fake key was put in ServerKeygenUserKeyDefault
                ...
                if (ext != null) {
                    ...
                    // from the "fake key",
                    // so we could use its length to determine the size
                    // of the new hash.
                    //
                    ...
                    logger.debug(method + "info after SKI replacement: " + info);
        ...
        if (isSSKeygen) {
            ...
            try {
                ...
                if (kraConnector == null) {
                    ...
                    // check response
                    if (!request.isSuccess()) {
                        logger.error("CAEnrollProfile: Key retrieval failed");
    ...
    private Map<String, byte[]> processP12Password(Request request) throws EProfileException {
        ...
        logger.info("CAEnrollProfile: transport cert public key class: " + transPublicKey.getClass().getName());
