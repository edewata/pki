...
public class CAService implements IService {
    ...
    private X509CertImpl issueX509Cert(
        ...
        logger.info("CAService: Issuing cert using CA " + aid);
        ...
        try {
            ...
            logger.info("CAService: - new cert is CA: " + is_ca);
        ...
        try {
            if (renewal) {
                ...
                logger.info("CAService: - renewing cert " + serialnum.getNumber());
            }
        ...
        try {
            ...
            logger.info("CAService: - new serial number: 0x" + serialNo.toString(16));
        ...
        try {
            ...
            if (issuer != null) {
                ...
                logger.info("CAService: - CA issuer object: " + issuer);
                certi.set(X509CertInfo.ISSUER, issuer);

            } else {
                issuer = new CertificateIssuerName(ca.getX500Name());
                logger.info("CAService: - new issuer object: " + issuer);
                certi.set(X509CertInfo.ISSUER, issuer);
            }
